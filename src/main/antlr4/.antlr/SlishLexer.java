...
public class SlishLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "T__36", "T__37", "T__38", "UNDERSCORE", "COMMENT", 
			"WS", "INTEGER", "FLOAT", "BOOL", "STRING", "STRING_WITH_INTERPOLATION", 
			"STRING_START", "STRING_MIDDLE", "STRING_END", "IDENTIFIER"
		};
	}
	...
	public SlishLexer(CharStream input) {
		super(input);
